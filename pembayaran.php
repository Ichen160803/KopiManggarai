...
<head>
  ...
  function showSuccessMessage() {
      ...
      alert
  alert('Pesanan kamu berhasil dibuat');
...
<body>
  ...
  <form action="" method="post" onsubmit="showSuccessMessage()">
    ...
    <div>
      ...
      <input type="text" id="produk" name="produk" value="<?php echo $productName; ?>" readonly>
    </div>
    <div>
    ...
    <div>
      ...
      <input type="text" id="total_harga" name="total_harga" value="<?php echo $productPrice; ?>" readonly>
    </div>
